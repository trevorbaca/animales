...
1.  Change build prefix to build.

2.  Make multiple baca.build(..., baca.spacing())
    work regardless of (lexical) order.

3.  Write baca.build() doctests.

4.  Audit IDE segment collection tag handling.
    Make sure (lyc*) deactivates all SEGMENT+ tags.
    
5.  Reread IDE 'layout - make (yom)' command.
    Reread boilerplate __make_layout_ly__.py.

6.  Clean up existing build directories.

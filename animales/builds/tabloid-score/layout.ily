...
SpacingCommands = {
    ...
    \baca-start-strict-spacing-section #35 #384
    s1 * 3/4

    % [SpacingCommands measure 30]
    \baca-start-strict-spacing-section #1 #14
    s1 * 4/4
    ...
    \baca-start-strict-spacing-section #35 #336
    s1 * 4/4
    ...
    \baca-start-strict-spacing-section #35 #192
    s1 * 4/4
    ...
    \baca-start-strict-spacing-section #1 #45
    s1 * 3/4

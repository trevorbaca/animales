...
<<
    ...
    <<
        ...
        %@% ^ \markup { \make-forest-green "[[1/16 * 35/24]]" }                          %! HSS2:SPACING_MARKUP
            ...
            \break                                                                       %! IC:BREAK
            s1 * 1
        %@% ^ \markup { \make-forest-green "[1/14]" }                                    %! HSS2:SPACING_MARKUP
        ...
        %@% ^ \markup { \make-forest-green "[1/14]" }                                    %! HSS2:SPACING_MARKUP
            ...
            \noBreak                                                                     %! BMM2:BREAK
            s1 * 1
        %@% ^ \markup { \make-forest-green "[[1/14 * 35/24]]" }                          %! HSS2:SPACING_MARKUP
        ...
        %@% ^ \markup { \make-forest-green "[1/8]" }                                     %! HSS2:SPACING_MARKUP
            ...
            \noBreak                                                                     %! BMM2:BREAK
            s1 * 1
        %@% ^ \markup { \make-forest-green "[[1/8 * 35/24]]" }                           %! HSS2:SPACING_MARKUP
        ...
        %@% ^ \markup { \make-forest-green "[[1/20 * 35/24]]" }                          %! HSS2:SPACING_MARKUP
            ...
            \pageBreak                                                                   %! IC:BREAK
            s1 * 3/4
        %@% ^ \markup { \make-forest-green "[1/45]" }                                    %! HSS2:SPACING_MARKUP
        ...
        %@% ^ \markup { \make-forest-green "[1/45]" }                                    %! HSS2:SPACING_MARKUP
            ...
            \noBreak                                                                     %! BMM2:BREAK
            s1 * 1/4
        %@% ^ \markup { \make-forest-green "[[1/45 * 35/24]]" }                          %! HSS2:SPACING_MARKUP

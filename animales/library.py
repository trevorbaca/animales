...
def parts(section, token=None):
    ...
    ..  container:: example
        ...
        >>> pac = animales.library.parts("Horn")
        >>> string = abjad.format.storage(pac)
        >>> print(string)
        ...
        >>> pac = animales.library.parts("Horn", 1)
        >>> string = abjad.format.storage(pac)
        >>> print(string)
        baca.PartAssignmentCommand(
        ...
        >>> pac = animales.library.parts("Horn", 2)
        >>> string = abjad.format.storage(pac)
        >>> print(string)
        baca.PartAssignmentCommand(
        ...
        >>> pac = animales.library.parts("Horn", (3, 4))
        >>> string = abjad.format.storage(pac)
        >>> print(string)
        baca.PartAssignmentCommand(
        ...
        >>> pac = animales.library.parts("Horn", [1, 3])
        >>> string = abjad.format.storage(pac)
        >>> print(string)
        baca.PartAssignmentCommand(

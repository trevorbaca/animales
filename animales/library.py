...
def voice_abbreviations():
    ...
    ..  container:: example
        ...
        >>> string = abjad.storage(animales.library.voice_abbreviations())
        >>> print(string)
        dict(
            {
...
def make_empty_score(
    ...
    music_context = baca.templates.make_music_context(
        baca.templates.make_staff_group(
            "Wind",
            *baca.templates.group_families(
                (
                    "FluteFamily",
                    baca.templates.make_square_staff_group("Flute", *flute_staves),
                ),
                (
                    "OboeFamily",
                    baca.templates.make_square_staff_group("Oboe", *oboe_staves),
                    baca.templates.make_square_staff_group(
                ...
                (
                    "BassoonFamily",
                    baca.templates.make_square_staff_group("Bassoon", *bassoon_staves),
                ),
            ),
        ),
        baca.templates.make_staff_group(
            "Brass",
            baca.templates.make_square_staff_group("Horn", *horn_staves),
            baca.templates.make_square_staff_group("Trumpet", *trumpet_staves),
            baca.templates.make_square_staff_group("Trombone", *trombone_staves),
            baca.templates.make_square_staff_group("Tuba", *tuba_staves),
        ),
        baca.templates.make_piano_staff("Piano", *piano_staves),
        baca.templates.make_piano_staff("Harp", *harp_staves),
        baca.templates.make_staff_group("Percussion", *percussion_staves),
        baca.templates.make_staff_group(
            "String",
            baca.templates.make_square_staff_group("FirstViolin", *first_violin_staves),
            baca.templates.make_square_staff_group(
                "SecondViolin", *second_violin_staves
            ),
            baca.templates.make_square_staff_group("Viola", *viola_staves),
            baca.templates.make_square_staff_group("Cello", *cello_staves),
            baca.templates.make_square_staff_group("Contrabass", *contrabass_staves),
        ),
    )

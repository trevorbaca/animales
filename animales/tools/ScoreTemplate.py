...
class ScoreTemplate(baca.ScoreTemplate):
    ...
    _part_manifest = (
        ...
        ('PercussionIV', 'PERC_4'),
        ('FirstViolinI', 'VN_1_1', 'Violin'),
        ('FirstViolinII', 'VN_1_2', 'Violin'),
        ('FirstViolinIII', 'VN_1_3', 'Violin'),
        ('FirstViolinIV', 'VN_1_4', 'Violin'),
        ('FirstViolinV', 'VN_1_5', 'Violin'),
        ('FirstViolinVI', 'VN_1_6', 'Violin'),
        ('FirstViolinVII', 'VN_1_7', 'Violin'),
        ('FirstViolinVIII', 'VN_1_8', 'Violin'),
        ('FirstViolinIX', 'VN_1_9', 'Violin'),
        ('FirstViolinX', 'VN_1_10', 'Violin'),
        ('FirstViolinXI', 'VN_1_11', 'Violin'),
        ('FirstViolinXII', 'VN_1_12', 'Violin'),
        ('FirstViolinXIII', 'VN_1_13', 'Violin'),
        ('FirstViolinXIV', 'VN_1_14', 'Violin'),
        ('FirstViolinXV', 'VN_1_15', 'Violin'),
        ('FirstViolinXVI', 'VN_1_16', 'Violin'),
        ('FirstViolinXVII', 'VN_1_17', 'Violin'),
        ('FirstViolinXVIII', 'VN_1_18', 'Violin'),
        ('SecondViolinI', 'VN_2_1', 'Violin'),
        ('SecondViolinII', 'VN_2_2', 'Violin'),
        ('SecondViolinIII', 'VN_2_3', 'Violin'),
        ('SecondViolinIV', 'VN_2_4', 'Violin'),
        ('SecondViolinV', 'VN_2_5', 'Violin'),
        ('SecondViolinVI', 'VN_2_6', 'Violin'),
        ('SecondViolinVII', 'VN_2_7', 'Violin'),
        ('SecondViolinVIII', 'VN_2_8', 'Violin'),
        ('SecondViolinIX', 'VN_2_9', 'Violin'),
        ('SecondViolinX', 'VN_2_10', 'Violin'),
        ('SecondViolinXI', 'VN_2_11', 'Violin'),
        ('SecondViolinXII', 'VN_2_12', 'Violin'),
        ('SecondViolinXIII', 'VN_2_13', 'Violin'),
        ('SecondViolinXIV', 'VN_2_14', 'Violin'),
        ('SecondViolinXV', 'VN_2_15', 'Violin'),
        ('SecondViolinXVI', 'VN_2_16', 'Violin'),
        ('SecondViolinXVII', 'VN_2_17', 'Violin'),
        ('SecondViolinXVIII', 'VN_2_18', 'Violin'),
        ('ViolaI', 'VA_1'),
        ('ViolaII', 'VA_2'),
        ('ViolaIII', 'VA_3'),
        ('ViolaIV', 'VA_4'),

...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.First_Violins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Violin”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. I (1-10)”]"
    % SPANNER_STARTS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.First_Violins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.1.First_Violins.Music.1.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.First_Violins.Music.3.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Violin”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. I (11-18)”]"
    % TRILL_SPANNER_STARTS:
      %! SPANNER_START
      %! baca.SpannerIndicatorCommand._call(2)
      %! baca.trill_spanner()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.First_Violins.Music.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.1.First_Violins.Music.3.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
      %! baca._style_anchor_notes()
    % [First_Violins.Music.3 anchor note]
    % BEFORE:
    % COMMANDS:
      %! ANCHOR_NOTE
      %! INVISIBLE_MUSIC_COMMAND
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Second_Violin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Violin”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. II (1-10)”]"
    % SPANNER_STARTS:
      %! baca._attach_shadow_tie_indicators()
    - \tweak stencil ##f
      %! baca._attach_shadow_tie_indicators()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Second_Violin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.1.Second_Violin.Music.1.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Second_Violin.Music.3.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.5 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Violin”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. II (11-18)”]"
    % SPANNER_STARTS:
      %! baca._attach_shadow_tie_indicators()
    - \tweak stencil ##f
      %! baca._attach_shadow_tie_indicators()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.Second_Violin.Music.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.1.Second_Violin.Music.3.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
      %! baca._style_anchor_notes()
    % [Second_Violin.Music.3 anchor note]
    % BEFORE:
    % COMMANDS:
      %! ANCHOR_NOTE
      %! INVISIBLE_MUSIC_COMMAND
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Viola”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vle. (1-10)”]"
    % TRILL_SPANNER_STARTS:
      %! SPANNER_START
      %! baca.SpannerIndicatorCommand._call(2)
      %! baca.trill_spanner()
...
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)
    ...
    ^ \baca-explicit-instrument-markup "(“Viola”)"
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vle. (11-18)”]"
    % TRILL_SPANNER_STARTS:
      %! SPANNER_START
      %! baca.SpannerIndicatorCommand._call(2)
      %! baca.trill_spanner()

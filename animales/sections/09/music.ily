...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.FirstViolins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.FirstViolins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.9.FirstViolins.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.SecondViolin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.SecondViolin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.9.SecondViolin.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:

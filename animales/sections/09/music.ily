...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.Clarinet.Music.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.9.Clarinet.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.9.Clarinet.Music.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.9.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.9.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.9.Percussion.Voice.3.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.9.Percussion.Voice.3 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.9.Percussion.Voice.3.container }
    % CLOSING:
    % COMMANDS:

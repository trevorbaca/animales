            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Clarinet.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Clarinet.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Bass_Clarinet.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Bass_Clarinet.Staff.1 }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Piano.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Piano.Staff.1 }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Percussion.Staff.2"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Percussion.Staff.2 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Percussion.Staff.3"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Percussion.Staff.3 }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "First_Violins.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.First_Violins.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Second_Violin.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Second_Violin.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Viola.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Viola.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Cello.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.9.Cello.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    <<
                        ...
                        \context Staff = "Contrabass.Staff.1"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.9.Contrabass.Staff.1 }
                        % ABSOLUTE_BEFORE:
                        % COMMANDS:
                        ...
                        \context Staff = "Contrabass.Staff.2"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.9.Contrabass.Staff.2 }
                        % CLOSING:
                        % COMMANDS:

...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.Voice.1.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.Voice.1 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.Voice.1.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.Voice.3.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.Voice.3 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.Voice.3.container }
    % CLOSING:
    % COMMANDS:

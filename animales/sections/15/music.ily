...
>>
  ...
  %! baca.path.extern()
number.15.SecondViolins.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.SecondViolins.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.SecondViolins.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.15.SecondViolins.Staff.1 = {
    ...
    \context Voice = "SecondViolins.1.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.SecondViolins.1.Music }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Violas.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Violas.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Violas.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Cellos.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Cellos.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Cellos.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabasses.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Contrabasses.1.Music measure 7]
    % BEFORE:
    % COMMANDS:
      %! +PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabasses.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Contrabasses.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabasses.3.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "Contrabasses.3.Rests"
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [Contrabasses.3.Rests measure 4]
              %! MULTIMEASURE_REST
              %! REST_VOICE
              %! baca._make_multimeasure_rest_container(5)
            R1 * 4/4
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabasses.3.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Contrabasses.3.Music.part.1 }
    % CLOSING:
    % COMMANDS:

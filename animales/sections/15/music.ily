...
%%% \ff
    ...
    ^ \baca-reapplied-instrument-markup "(“Flutes”)"
      ...
      %! baca._attach_latent_indicator_alert()
    ^ \baca-reapplied-short-instrument-name-markup "[“Fl. (1+3)”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
...
%%% \ff
    ...
    ^ \baca-reapplied-instrument-markup "(“Flutes”)"
      %! REAPPLIED_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-reapplied-short-instrument-name-markup "[“Fl. (2+4)”]"
    % ABSOLUTE_AFTER:
    % COMMANDS:
      %! REAPPLIED_CLEF_REDRAW_COLOR
      %! baca._attach_color_literal(2)
...
>>
  ...
  %! baca.path.extern()
number.15.Bass_Clarinet.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Bass_Clarinet.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Bass_Clarinet.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.First_Violins.Music.2.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.First_Violins.Music.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.First_Violins.Music.2.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.First_Violins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.First_Violins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.First_Violins.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.15.First_Violins.Staff.1 = <<
    ...
    \context Voice = "First_Violins.Music.2"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.First_Violins.Music.2 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    \context Voice = "First_Violins.Music.1"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.First_Violins.Music.1 }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Second_Violin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Second_Violin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Second_Violin.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.15.Second_Violin.Staff.1 = {
    ...
    \context Voice = "Second_Violin.Music.1"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.Second_Violin.Music.1 }
    % CLOSING:
    % COMMANDS:

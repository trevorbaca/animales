...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

      %! baca._comment_measure_numbers()
    % [Flutes.1.Music measure 1]
    % BEFORE:
    % COMMANDS:
...
%%% \ff
    ...
    ^ \baca-reapplied-instrument-markup "(“Flutes”)"
    % ABSOLUTE_AFTER:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Flutes.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.3.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

      %! baca._comment_measure_numbers()
    % [Flutes.3.Music measure 1]
    % OPENING:
    % COMMANDS:
      %! -PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.3.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Flutes.3.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.15.Flutes.Staff.1 = <<
    ...
    % OPEN_BRACKETS:
      %! animales._make_staves()
    \context Voice = "Flutes.1.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.Flutes.1.Music }
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! animales._make_staves()
    \context Voice = "Flutes.3.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.Flutes.3.Music }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.Flutes.2.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

      %! baca._comment_measure_numbers()
    % [Flutes.2.Music measure 1]
    % BEFORE:
    % COMMANDS:
      %! baca._clone_section_initial_short_instrument_name()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.2.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Flutes.2.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.4.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

      %! baca._comment_measure_numbers()
    % [Flutes.4.Music measure 1]
    % OPENING:
    % COMMANDS:
      %! -PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Flutes.4.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Flutes.4.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.15.Flutes.Staff.2 = <<
    ...
    % OPEN_BRACKETS:
      %! animales._make_staves()
    \context Voice = "Flutes.2.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.Flutes.2.Music }
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! animales._make_staves()
    \context Voice = "Flutes.4.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.15.Flutes.4.Music }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.1.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.2.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.2.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.2.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Percussion.3.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.15.Percussion.3.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Percussion.3.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.FirstViolins.2.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.FirstViolins.2.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.FirstViolins.2.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.FirstViolins.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.FirstViolins.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.FirstViolins.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.15.SecondViolin.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "SecondViolin.1.Rests"
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [SecondViolin.1.Rests measure 4]
              %! MULTIMEASURE_REST
              %! REST_VOICE
              %! baca._make_multimeasure_rest_container(5)
            R1 * 4/4
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.SecondViolin.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.SecondViolin.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.SecondViolin.Staff.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Viola.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Viola.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Viola.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Cello.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Cello.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Cello.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.1.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.1.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Contrabass.1.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.3.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
        ...
        % OPEN_BRACKETS:
          %! baca._make_multimeasure_rest_container(6)
        \context Voice = "Contrabass.3.Rests"
          %! baca._make_multimeasure_rest_container(6)
        {
            % ABSOLUTE_BEFORE:
            % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.15.Contrabass.3.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.15.Contrabass.3.Music.part.1 }
    % CLOSING:
    % COMMANDS:

...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Clarinet.Music.container.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Clarinet.Music.container.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Clarinet.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.7.Clarinet.Music.container.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.7.Clarinet.Music.container.2 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Percussion.Voice.1.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Percussion.Voice.1 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.7.Percussion.Voice.1.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.7.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.7.Percussion.Voice.3.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.7.Percussion.Voice.3 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.7.Percussion.Voice.3.container }
    % CLOSING:
    % COMMANDS:

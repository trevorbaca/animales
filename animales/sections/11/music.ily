...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Clarinet.Music.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.11.Clarinet.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.11.Clarinet.Music.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.11.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.11.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Percussion.Voice.3.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.11.Percussion.Voice.3 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.11.Percussion.Voice.3.container }
    % CLOSING:
    % COMMANDS:

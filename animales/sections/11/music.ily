...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.First_Violins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.First_Violins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.11.First_Violins.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.11.First_Violins.Staff.1 = {
    ...
    \context Voice = "First_Violins.Music.1"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.11.First_Violins.Music.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Second_Violin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.11.Second_Violin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.11.Second_Violin.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.11.Second_Violin.Staff.1 = {
    ...
    \context Voice = "Second_Violin.Music.1"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.11.Second_Violin.Music.1 }
    % CLOSING:
    % COMMANDS:

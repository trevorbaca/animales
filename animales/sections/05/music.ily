...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.5.Clarinet.Music.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.5.Clarinet.Music = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.5.Clarinet.Music.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.5.Percussion.Voice.1.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.5.Percussion.Voice.1 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.5.Percussion.Voice.1.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.5.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.5.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.5.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:

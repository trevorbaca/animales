    ...
    def crescendi_function(argument):
        ...
        for i, run in enumerate(runs):
            if i == 0:
                ...
                baca.hairpin_function(run, "mp < f")
            elif i == 2:
                baca.hairpin_function(run, "mp < ff")

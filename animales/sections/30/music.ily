...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
section_number.30.Piano.Music_Voice.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \revert TextScript.X-offset
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Piano.Music_Voice.1 measure 10]
    % BEFORE:
    % COMMANDS:
      %! +PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
section_number.30.Piano.Music_Voice.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % [Piano.Music_Voice.1 measure 11]
            % BEFORE:
            % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
section_number.30.Percussion.Music_Voice.4.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
section_number.30.Percussion.Music_Voice.4 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

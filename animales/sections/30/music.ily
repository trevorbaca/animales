...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Piano.Music_Voice.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Piano.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.30.Piano.Music_Voice.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Music_Voice.4.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \override TextScript.X-offset = 3
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Music_Voice.4 measure 7]
      %! baca.make_tied_repeated_durations()
    c'4
    % AFTER:
    % SPANNER_STARTS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Music_Voice.4 measure 8]
      %! baca.make_tied_repeated_durations()
    c'4
    % AFTER:
    % SPANNER_STARTS:
...
%%% \revert TextScript.X-offset
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Music_Voice.4 measure 9]
      %! baca._make_mmrests_flat()
    R1 * 1
    % AFTER:
    % MARKUP:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Music_Voice.4 measure 10]
    % BEFORE:
    % COMMANDS:
      %! +PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Music_Voice.4 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.30.Percussion.Music_Voice.4.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(4)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.Music_Voice.4 measure 11]
            % BEFORE:
            % COMMANDS:
              %! INVISIBLE_MUSIC_COMMAND
              %! MULTIMEASURE_REST
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
              %! baca._style_phantom_measures(5)
            % [Percussion.RestVoice.4 measure 11]
            % OPENING:
            % COMMANDS:
              %! PHANTOM
              %! baca._style_phantom_measures(7)
...
number.30.Percussion.Staff.4 = {
    ...
    \context Voice = "Percussion.Music_Voice.4"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.30.Percussion.Music_Voice.4 }
    % CLOSING:
    % COMMANDS:

...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Voice.4.Music.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \override TextScript.X-offset = 3
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Voice.4.Music measure 7]
      %! baca.make_tied_repeated_durations()
    c'4
    % AFTER:
    % SPANNER_STARTS:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Voice.4.Music measure 8]
      %! baca.make_tied_repeated_durations()
    c'4
    % AFTER:
    % SPANNER_STARTS:
...
%%% \revert TextScript.X-offset
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Voice.4.Music measure 9]
      %! baca.make_mmrests_function()
    R1 * 4/4
    % AFTER:
    % MARKUP:
    ...
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
    % [Percussion.Voice.4.Music measure 10]
    % BEFORE:
    % COMMANDS:
      %! +PARTS
      %! baca.IndicatorCommand._call()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Voice.4.Music = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.30.Percussion.Voice.4.Music.part.1 }
    % CLOSING:
    % COMMANDS:
...
number.30.Percussion.Staff.4 = {
    ...
    \context Voice = "Percussion.Voice.4.Music"
      %! animales._make_staves()
      %! baca.path.extern()
    { \number.30.Percussion.Voice.4.Music }
    % CLOSING:
    % COMMANDS:

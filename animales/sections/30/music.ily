...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Music.4.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
%%% \override TextScript.X-offset = 3
    ...
    ^ \animales-stonecircle-markup
      ...
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Perc. 4 (slate)”]"
      %! REAPPLIED_INSTRUMENT_ALERT
      %! baca._attach_latent_indicator_alert()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.30.Percussion.Music.4 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.30.Percussion.Music.4.part.1 }
    % CLOSING:
    % COMMANDS:

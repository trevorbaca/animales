...
def make_empty_score(previous_final_measure_number):
    assert previous_final_measure_number == 133
...
def make_score(
    ...
    SKIPS(score)
    library.MAKE_BATTUTI(score, time_signatures, [[1, -55], [1, -17], [1, -17]], (1, 3))
    ...
    library.make_battuti(cache, time_signatures, [[1, -55], [1, -17], [1, -17]], (1, 3))
    strings(cache)
    return score
...
def make_layout():
    layout = baca.layout.layout(
        baca.layout.page(
            1,
            baca.layout.System(1, y_offset=0, distances=(20, 8)),
        ),

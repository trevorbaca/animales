...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.26.Percussion.Voice.2.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.26.Percussion.Voice.2 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.26.Percussion.Voice.2.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.26.Percussion.Voice.3.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.26.Percussion.Voice.3 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.26.Percussion.Voice.3.container }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.26.Percussion.Voice.4.container = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.26.Percussion.Voice.4 = {
    ...
    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.26.Percussion.Voice.4.container }
    % CLOSING:
    % COMMANDS:

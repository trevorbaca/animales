            ...
            <<
                ...
                <<
                    ...
                    \context Staff = "Clarinet.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.6.Clarinet.Staff.1 }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    \context Staff = "Percussion.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.6.Percussion.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Percussion.Staff.2"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.6.Percussion.Staff.2 }
                    % CLOSING:
                    % COMMANDS:
                ...
                <<
                    ...
                    <<
                        ...
                        \context Staff = "First_Violins.Staff.1"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.First_Violins.Staff.1 }
                        % ABSOLUTE_BEFORE:
                        % COMMANDS:
                        ...
                        \context Staff = "First_Violins.Staff.2"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.First_Violins.Staff.2 }
                        % CLOSING:
                        % COMMANDS:
                    ...
                    <<
                        ...
                        \context Staff = "Second_Violin.Staff.1"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.Second_Violin.Staff.1 }
                        % ABSOLUTE_BEFORE:
                        % COMMANDS:
                        ...
                        \context Staff = "Second_Violin.Staff.2"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.Second_Violin.Staff.2 }
                        % CLOSING:
                        % COMMANDS:
                    ...
                    <<
                        ...
                        \context Staff = "Viola.Staff.1"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.Viola.Staff.1 }
                        % ABSOLUTE_BEFORE:
                        % COMMANDS:
                        ...
                        \context Staff = "Viola.Staff.2"
                          %! animales._make_staves()
                          %! baca.path.extern()
                        { \section_number.6.Viola.Staff.2 }
                        % CLOSING:
                        % COMMANDS:
                    ...
                    \context Staff = "Cello.Staff.1"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.6.Cello.Staff.1 }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    \context Staff = "Contrabass.Staff.2"
                      %! animales._make_staves()
                      %! baca.path.extern()
                    { \section_number.6.Contrabass.Staff.2 }
                    % CLOSING:
                    % COMMANDS:

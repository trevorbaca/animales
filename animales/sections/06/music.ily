...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Percussion.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Percussion.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Percussion.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Percussion.Music.2.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Percussion.Music.2 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Percussion.Music.2.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.First_Violins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    % MARKUP:
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. I”]"
      %! REAPPLIED_INSTRUMENT_ALERT
      %! baca._attach_latent_indicator_alert()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.First_Violins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.First_Violins.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.First_Violins.Music.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Second_Violin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    % MARKUP:
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vni. II”]"
      %! REAPPLIED_INSTRUMENT_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-reapplied-instrument-markup "(“Violin”)"
    % SPANNER_STARTS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Second_Violin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Second_Violin.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Second_Violin.Music.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
number.6.Viola.Music.1.part.1 = {
    ...
    % MARKUP:
      %! EXPLICIT_SHORT_INSTRUMENT_NAME_ALERT
      %! baca._attach_latent_indicator_alert()
    ^ \baca-explicit-short-instrument-name-markup "[“Vle.”]"
      %! REAPPLIED_INSTRUMENT_ALERT
      %! baca._attach_latent_indicator_alert()
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Viola.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Viola.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Cello.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Cello.Music.1.part.1 }
    % CLOSING:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Contrabass.Music.3.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.6.Contrabass.Music.3 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.6.Contrabass.Music.3.part.1 }
    % CLOSING:
    % COMMANDS:

...
def CL_BCL(score, signatures):
    voice = score[library.voice_abbreviations["cl"]]
    music = baca.make_repeat_tied_notes(signatures(1, 6))
    voice.extend(music)
    # BCL
...
def perc2(m):
    with baca.scope(m.leaves()) as o:
        ...
        baca.hairpin(o, "mp >o", right_broken=True)

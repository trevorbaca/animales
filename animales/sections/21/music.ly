            ...
            <<
                ...
                <<
                    ...
                    <<
                        ...
                        { \number.21.Contrabasses.Staff.1 }

                        \context Staff = "Contrabasses.Staff.2"
                        { \number.21.Contrabasses.Staff.2 }

                        \context Staff = "Contrabasses.Staff.3"
                        { \number.21.Contrabasses.Staff.3 }

...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.10.FirstViolins.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.10.FirstViolins.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.10.FirstViolins.Music.1.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    % [FirstViolins.Music.1 anchor note]
    % BEFORE:
    % COMMANDS:
      %! ANCHOR_NOTE
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.10.SecondViolin.Music.1.part.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.10.SecondViolin.Music.1 = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

    % OPEN_BRACKETS:
      %! baca.path.extern()
    { \number.10.SecondViolin.Music.1.part.1 }
    % ABSOLUTE_BEFORE:
    % COMMANDS:
      ...
      %! baca._comment_measure_numbers()
      %! baca._style_anchor_notes()
    % [SecondViolin.Music.1 anchor note]
    % BEFORE:
    % COMMANDS:
      %! ANCHOR_NOTE
      %! INVISIBLE_MUSIC_COMMAND

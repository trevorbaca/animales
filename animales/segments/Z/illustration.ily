...
%@% ^ \baca-stage-number-markup "[Z.1]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
...
%@% ^ \baca-stage-number-markup "[Z.2]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
...
%@% \bacaStartTextSpanLMN                                                      %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(2)
%@% - \baca-start-mn-both "156" "157"                                          %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)

    % [Z Global_Skips measure 157 / measure 3]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% ^ \baca-stage-number-markup "[Z.3]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers

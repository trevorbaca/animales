Z_GlobalRests = {
    ...
    % [Z GlobalRests measure 165]                                        %! SM4
    R1 * 3/4
    
    % [Z GlobalRests measure 166]                                        %! SM4
    R1 * 3/4
    
    % [Z GlobalRests measure 167]                                        %! SM4
    R1 * 1
    
    % [Z GlobalRests measure 168]                                        %! SM4
    R1 * 1
    
    % [Z GlobalRests measure 169]                                        %! SM4
    R1 * 1
    
    % [Z GlobalRests measure 170]                                        %! SM4
    R1 * 3/4
    
    % [Z GlobalRests measure 171]                                        %! SM4
    R1 * 3/4
    
    % [Z GlobalRests measure 172]                                        %! SM4
    R1 * 1
    
    % [Z GlobalRests measure 173]                                        %! SM4
    R1 * 1
    
    % [Z GlobalRests measure 174]                                        %! SM4
...
%@%     }                                                                %! SM27:REAPPLIED_METRONOME_MARK:SM36 %! SM29:METRONOME_MARK_SPANNER
    ...
    ^ \markup {
        \column
            ...
            %@%             \fontsize                                    %! SM28:CLOCK_TIME_MARKUP
            %@%                 #3                                       %! SM28:CLOCK_TIME_MARKUP
            %@%                 [6'02'']                                 %! SM28:CLOCK_TIME_MARKUP
            %@%     }                                                    %! SM28:CLOCK_TIME_MARKUP
            }
        }
    
    % [Z GlobalSkips measure 172]                                        %! SM4
    \time 4/4                                                            %! SM8:EXPLICIT_TIME_SIGNATURE:SM1
    \once \override Score.TimeSignature.color = #(x11-color 'blue)       %! SM6:EXPLICIT_TIME_SIGNATURE_COLOR:SM1
    s1 * 1
    ^ \markup {
...
%@% \override Staff.Clef.color = ##f                         %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    % [Z PianoVoiceI measure 166]                            %! SM4
    cs'2.
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 167]                            %! SM4
    cs'1
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 168]                            %! SM4
    cs'1
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 169]                            %! SM4
    cs'1
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 170]                            %! SM4
    cs'2.
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 171]                            %! SM4
    cs'2.
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 172]                            %! SM4
    cs'1
    -\laissezVibrer                                          %! IC
    
    % [Z PianoVoiceI measure 173]                            %! SM4
    cs'1
    -\laissezVibrer                                          %! IC
...
Z_PercussionVoiceIV_a = {
    ...
    % [Z PercussionVoiceIV measure 165]                      %! SM4
        ...
        \hcenter-in                                          %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
            ...
            \center-column                                   %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
                {                                            %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
                    ...
                    (slate)                                  %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
                }                                            %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
        }                                                    %! SM8:EXPLICIT_MARGIN_MARKUP:IC:-PARTS
...
%@% \override Staff.Clef.color = ##f                         %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
                ...
                \line                                        %! SM11:EXPLICIT_MARGIN_MARKUP_ALERT:IC:-PARTS
                    {                                        %! SM11:EXPLICIT_MARGIN_MARKUP_ALERT:IC:-PARTS
                        \with-color                          %! SM11:EXPLICIT_MARGIN_MARKUP_ALERT:IC:-PARTS
                            ...
                            "[“Perc. 4 (slate)”]"            %! SM11:EXPLICIT_MARGIN_MARKUP_ALERT:IC:-PARTS
                    }                                        %! SM11:EXPLICIT_MARGIN_MARKUP_ALERT:IC:-PARTS
            }
        }
    \override Staff.Clef.color = #(x11-color 'OliveDrab)     %! SM6:REAPPLIED_CLEF_REDRAW_COLOR:SM37
        ...
        \hcenter-in                                          %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
            ...
            \center-column                                   %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
                {                                            %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
                    ...
                    (slate)                                  %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
                }                                            %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
        }                                                    %! SM8:REDRAWN_EXPLICIT_MARGIN_MARKUP:SM34:IC:-PARTS
    ...
    % [Z PercussionVoiceIV measure 166]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 167]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 168]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 169]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 170]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 171]                      %! SM4
    c'4
    \repeatTie
    ...
    % [Z PercussionVoiceIV measure 172]                      %! SM4
    c'4
    \repeatTie
...
Z_PercussionVoiceIV = {
    ...
    % [Z PercussionVoiceIV measure 173]                          %! SM4
    R1 * 1
    
    % [Z PercussionVoiceIV measure 174]                          %! SM4
    R1 * 1/4

...
%@% ^ \baca-dark-cyan-markup [Y.1]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [Y.2]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [Y.3]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP

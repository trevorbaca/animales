...
%@% ^ \baca-stage-number-markup "[Y.1]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
...
%@% \startTextSpan                                                             %! REAPPLIED_METRONOME_MARK:_set_status_tag:_reapply_persistent_indicators(2):_attach_metronome_marks(2)
    ...
    s1 * 1                                                                     %! _make_global_skips(1)
%@% ^ \baca-stage-number-markup "[Y.2]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
...
%@% \bacaStartTextSpanLMN                                                      %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(2)
%@% - \baca-start-mn-both "153" "154"                                          %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)

    % [Y Global_Skips measure 154 / measure 3]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% ^ \baca-stage-number-markup "[Y.3]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers

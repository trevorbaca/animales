...
%@% ^ \baca-dark-cyan-markup [V.1]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [V.2]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [V.3]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP

...
maker(
    ...
    baca.pitches('A3 B3', persist='brass_pitches'),
...
maker(
    ...
    baca.pitches('Ab3 Bb3', persist='brass_pitches'),
...
maker(
    ...
    baca.score(baca.dynamics_up()),
    baca.pitches('Ab4 Bb4', persist='brass_pitches'),
    baca.score(baca.voice_one()),
    crescendi,
    )
...
maker(
    ...
    baca.pitches('G4 A4', persist='brass_pitches'),
    baca.score(baca.voice_two()),
    crescendi,
    )
...
maker(
    ...
    baca.pitches('G3 A3', persist='brass_pitches'),
    baca.score(baca.voice_two()),
    crescendi,
    )

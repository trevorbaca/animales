...
def tremolo_suite():
    return baca.suite(
        ...
        baca.only_parts(baca.markups.boxed('ext. ponticello: like acid')),
        baca.transition(
...
maker(
    ...
    baca.make_repeat_tied_notes(),
    baca.not_parts(baca.markups.boxed('tutti: ext. ponticello: like acid')),
    baca.not_parts(baca.markups.markup('1-4 + 5-8')),
    baca.pitch('A5'),
    tremolo_suite(),
    upper_voice_suite(),
    )
...
maker(
    ...
    baca.make_repeat_tied_notes(),
    baca.not_parts(baca.markups.markup('9-12 + 13-17')),
    baca.pitch('G5'),
    tremolo_suite(),
    upper_voice_suite(),
    )
...
maker(
    ...
    baca.make_repeat_tied_notes(),
    baca.not_parts(baca.markups.markup('9-12 + 13-18')),
    baca.pitch('A4'),
    tremolo_suite(),
    upper_voice_suite(),
    )
...
maker(
    ...
    baca.make_repeat_tied_notes(),
    baca.not_parts(baca.markups.markup('1-8 + 9-14')),
    baca.pitch('D3'),
    tremolo_suite(),
    upper_voice_suite(),
    )
...
maker(
    ...
    baca.make_repeat_tied_notes(),
    baca.not_parts(baca.markups.markup('Cb. tutti')),
    baca.pitch('G1'),
    baca.tag(
        '+LETTER_PARTS_CB-1',
        baca.clef('bass'),

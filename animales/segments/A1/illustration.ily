...
A_a_ContrabassVoiceIII_a = {
    
    % [A1 ContrabassVoiceIII measure 18]                     %! SM4
    \set Staff.instrumentName =                              %! SM8:DEFAULT_MARGIN_MARKUP:ST2:-PARTS
    \markup {                                                %! SM8:DEFAULT_MARGIN_MARKUP:ST2:-PARTS
        \hcenter-in                                          %! SM8:DEFAULT_MARGIN_MARKUP:ST2:-PARTS
            #16                                              %! SM8:DEFAULT_MARGIN_MARKUP:ST2:-PARTS
...
%@% \override Staff.Clef.color = ##f                         %! SM7:DEFAULT_CLEF_COLOR_CANCELLATION:ST3
    ...
    % [A1 ContrabassVoiceIII measure 19]                     %! SM4
    R1 * 1
    
    % [A1 ContrabassVoiceIII measure 20]                     %! SM4
    \once \override Voice.DynamicText.color = #(x11-color 'blue) %! SM6:EXPLICIT_DYNAMIC_COLOR:HC2
    c1
    \<                                                       %! HC1
    \p                                                       %! HC1
    
    % [A1 ContrabassVoiceIII measure 21]                     %! SM4
    c1
    \repeatTie
    
    % [A1 ContrabassVoiceIII measure 22]                     %! SM4
    c1
    \repeatTie
    
    % [A1 ContrabassVoiceIII measure 23]                     %! SM4
    c2.
    \repeatTie

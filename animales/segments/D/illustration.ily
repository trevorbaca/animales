D_Global_Rests = {                                                             %! abjad.Path.extern()
    ...
    % [D Global_Rests measure 30 / measure 7]                                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(4):PHANTOM
...
D_Global_Skips = {                                                             %! abjad.Path.extern()
    ...
    \time 3/4                                                                  %! baca.SegmentMaker._make_global_skips(2):baca.SegmentMaker._reapply_persistent_indicators(1):baca.SegmentMaker._set_status_tag():REAPPLIED_TIME_SIGNATURE
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER:baca.SegmentMaker._label_measure_numbers()
%@% - \baca-start-ct-both "[0'53'']" "[0'55'']"                                %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME:baca.SegmentMaker._label_clock_time()
    \baca-bar-line-visible                                                     %! baca.SegmentMaker._attach_final_bar_line()
    \bar "|"                                                                   %! baca.SegmentMaker._attach_final_bar_line()

    % [D Global_Skips measure 30 / measure 7]                                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
...
D_Clarinet_Voice_I_a = {                                                       %! abjad.Path.extern()
    ...
    % [D Clarinet_Voice_I measure 24 / measure 1]                              %! baca.SegmentMaker._comment_measure_numbers()
...
%%% ^ \markup { solo }                                                         %! baca.markup():+PARTS:baca.IndicatorCommand._call()
    ...
    % [D Clarinet_Voice_I measure 25 / measure 2]                              %! baca.SegmentMaker._comment_measure_numbers()
    ds''!1                                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Clarinet_Voice_I measure 26 / measure 3]                              %! baca.SegmentMaker._comment_measure_numbers()
    ds''!1                                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Clarinet_Voice_I measure 27 / measure 4]                              %! baca.SegmentMaker._comment_measure_numbers()
    ds''!1                                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Clarinet_Voice_I measure 28 / measure 5]                              %! baca.SegmentMaker._comment_measure_numbers()
    ds''!2.                                                                    %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Clarinet_Voice_I measure 29 / measure 6]                              %! baca.SegmentMaker._comment_measure_numbers()
    ds''!2.                                                                    %! baca.make_repeat_tied_notes()
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
...
D_Clarinet_Voice_I = {                                                         %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Clarinet_Voice_I measure 30 / measure 7]                      %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Clarinet_Rest_Voice_I measure 30 / measure 7]                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
...
D_Percussion_Voice_I_a = {                                                     %! abjad.Path.extern()
    ...
    % [D Percussion_Voice_I measure 24 / measure 1]                            %! baca.SegmentMaker._comment_measure_numbers()
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D Percussion_Voice_I measure 25 / measure 2]                            %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_I measure 26 / measure 3]                            %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_I measure 27 / measure 4]                            %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_I measure 28 / measure 5]                            %! baca.SegmentMaker._comment_measure_numbers()
    c'2.                                                                       %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_I measure 29 / measure 6]                            %! baca.SegmentMaker._comment_measure_numbers()
    c'2.                                                                       %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()
...
D_Percussion_Voice_I = {                                                       %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Percussion_Voice_I measure 30 / measure 7]                    %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Percussion_Rest_Voice_I measure 30 / measure 7]               %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Percussion_Voice_II_a = {                                                    %! abjad.Path.extern()
    ...
    % [D Percussion_Voice_II measure 24 / measure 1]                           %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D Percussion_Voice_II measure 25 / measure 2]                           %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_II measure 26 / measure 3]                           %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_II measure 27 / measure 4]                           %! baca.SegmentMaker._comment_measure_numbers()
    c'1                                                                        %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    - \tweak direction #up                                                     %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_II measure 28 / measure 5]                           %! baca.SegmentMaker._comment_measure_numbers()
    c'2.                                                                       %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Percussion_Voice_II measure 29 / measure 6]                           %! baca.SegmentMaker._comment_measure_numbers()
    c'2.                                                                       %! baca.make_repeat_tied_notes()
    :32                                                                        %! baca.stem_tremolo():baca.IndicatorCommand._call()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()
...
D_Percussion_Voice_II = {                                                      %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Percussion_Voice_II measure 30 / measure 7]                   %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Percussion_Rest_Voice_II measure 30 / measure 7]              %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_First_Violin_Voice_II_a = {                                                  %! abjad.Path.extern()
    ...
    % [D First_Violin_Voice_II measure 24 / measure 1]                         %! baca.SegmentMaker._comment_measure_numbers()
...
%%% \stopTrillSpan                                                             %! baca.literal():+PARTS:baca.IndicatorCommand._call()
    ...
    % [D First_Violin_Voice_II measure 25 / measure 2]                         %! baca.SegmentMaker._comment_measure_numbers()
    ...
    % [D First_Violin_Voice_II measure 26 / measure 3]                         %! baca.SegmentMaker._comment_measure_numbers()
    f'''8                                                                      %! animales.glissando_rhythm()
    [                                                                          %! rmakers.RewriteMeterCommand.__call__
    \glissando                                                                 %! baca.glissando()
    ...
    % [D First_Violin_Voice_II measure 27 / measure 4]                         %! baca.SegmentMaker._comment_measure_numbers()
    g'8                                                                        %! animales.glissando_rhythm()
    [                                                                          %! rmakers.RewriteMeterCommand.__call__
    \glissando                                                                 %! baca.glissando()
    ...
    b''4.                                                                      %! animales.glissando_rhythm()
    \glissando                                                                 %! baca.glissando()

    % [D First_Violin_Voice_II measure 28 / measure 5]                         %! baca.SegmentMaker._comment_measure_numbers()
    ...
    % [D First_Violin_Voice_II measure 29 / measure 6]                         %! baca.SegmentMaker._comment_measure_numbers()
    b''2                                                                       %! animales.glissando_rhythm()
    \glissando                                                                 %! baca.glissando()
...
D_First_Violin_Voice_II = {                                                    %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Voice_II measure 30 / measure 7]                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Rest_Voice_II measure 30 / measure 7]            %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_First_Violin_Voice_I_a = {                                                   %! abjad.Path.extern()
    ...
    % [D First_Violin_Voice_I measure 24 / measure 1]                          %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D First_Violin_Voice_I measure 25 / measure 2]                          %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D First_Violin_Voice_I measure 26 / measure 3]                          %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D First_Violin_Voice_I measure 27 / measure 4]                          %! baca.SegmentMaker._comment_measure_numbers()
    b4                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D First_Violin_Voice_I measure 28 / measure 5]                          %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D First_Violin_Voice_I measure 29 / measure 6]                          %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_First_Violin_Voice_I = {                                                     %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Voice_I measure 30 / measure 7]                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Rest_Voice_I measure 30 / measure 7]             %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_First_Violin_Voice_III_a = {                                                 %! abjad.Path.extern()
    ...
    % [D First_Violin_Voice_III measure 24 / measure 1]                        %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D First_Violin_Voice_III measure 25 / measure 2]                        %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D First_Violin_Voice_III measure 26 / measure 3]                        %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    - \accent                                                                  %! baca.accent():baca.IndicatorCommand._call()

    % [D First_Violin_Voice_III measure 27 / measure 4]                        %! baca.SegmentMaker._comment_measure_numbers()
    b4                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D First_Violin_Voice_III measure 28 / measure 5]                        %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D First_Violin_Voice_III measure 29 / measure 6]                        %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_First_Violin_Voice_III = {                                                   %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Voice_III measure 30 / measure 7]                %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D First_Violin_Rest_Voice_III measure 30 / measure 7]           %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Second_Violin_Voice_I_a = {                                                  %! abjad.Path.extern()
    ...
    % [D Second_Violin_Voice_I measure 24 / measure 1]                         %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D Second_Violin_Voice_I measure 25 / measure 2]                         %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Second_Violin_Voice_I measure 26 / measure 3]                         %! baca.SegmentMaker._comment_measure_numbers()
    b4.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Second_Violin_Voice_I measure 27 / measure 4]                         %! baca.SegmentMaker._comment_measure_numbers()
    b2..                                                                       %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Second_Violin_Voice_I measure 28 / measure 5]                         %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Second_Violin_Voice_I measure 29 / measure 6]                         %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_Second_Violin_Voice_I = {                                                    %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Second_Violin_Voice_I measure 30 / measure 7]                 %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Second_Violin_Rest_Voice_I measure 30 / measure 7]            %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Second_Violin_Voice_III_a = {                                                %! abjad.Path.extern()
    ...
    \times 2/3 {                                                               %! animales.sforzando_exchange_rhythm()
        ...
        % [D Second_Violin_Voice_III measure 24 / measure 1]                   %! baca.SegmentMaker._comment_measure_numbers()
        \set Staff.shortInstrumentName =                                       %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \markup {                                                              %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            \hcenter-in                                                        %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
                #16                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    ...
    % [D Second_Violin_Voice_III measure 25 / measure 2]                       %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Second_Violin_Voice_III measure 26 / measure 3]                       %! baca.SegmentMaker._comment_measure_numbers()
    b4                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Second_Violin_Voice_III measure 27 / measure 4]                       %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Second_Violin_Voice_III measure 28 / measure 5]                       %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    - \accent                                                                  %! baca.accent():baca.IndicatorCommand._call()

    % [D Second_Violin_Voice_III measure 29 / measure 6]                       %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_Second_Violin_Voice_III = {                                                  %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Second_Violin_Voice_III measure 30 / measure 7]               %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Second_Violin_Rest_Voice_III measure 30 / measure 7]          %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Viola_Voice_I_a = {                                                          %! abjad.Path.extern()
    ...
    % [D Viola_Voice_I measure 24 / measure 1]                                 %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D Viola_Voice_I measure 25 / measure 2]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Viola_Voice_I measure 26 / measure 3]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Viola_Voice_I measure 27 / measure 4]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Viola_Voice_I measure 28 / measure 5]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Viola_Voice_I measure 29 / measure 6]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_Viola_Voice_I = {                                                            %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Viola_Voice_I measure 30 / measure 7]                         %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Viola_Rest_Voice_I measure 30 / measure 7]                    %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Viola_Voice_III_a = {                                                        %! abjad.Path.extern()
    ...
    % [D Viola_Voice_III measure 24 / measure 1]                               %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    % [D Viola_Voice_III measure 25 / measure 2]                               %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    - \accent                                                                  %! baca.accent():baca.IndicatorCommand._call()

    % [D Viola_Voice_III measure 26 / measure 3]                               %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Viola_Voice_III measure 27 / measure 4]                               %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Viola_Voice_III measure 28 / measure 5]                               %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Viola_Voice_III measure 29 / measure 6]                               %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    - \accent                                                                  %! baca.accent():baca.IndicatorCommand._call()
...
D_Viola_Voice_III = {                                                          %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Viola_Voice_III measure 30 / measure 7]                       %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Viola_Rest_Voice_III measure 30 / measure 7]                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Cello_Voice_I_a = {                                                          %! abjad.Path.extern()
    ...
    % [D Cello_Voice_I measure 24 / measure 1]                                 %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%%% \once \override Staff.Clef.X-extent = ##f                                  %! baca.clef_x_extent_false():baca.clef_shift():SHIFTED_CLEF:MEASURE_24:baca.OverrideCommand._call(1)
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)                    %! baca.clef_extra_offset():baca.clef_shift():SHIFTED_CLEF:MEASURE_24:baca.OverrideCommand._call(1)
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):EXPLICIT_CLEF_COLOR_CANCELLATION
    ...
    % [D Cello_Voice_I measure 25 / measure 2]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Cello_Voice_I measure 26 / measure 3]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b1                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Cello_Voice_I measure 27 / measure 4]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b8                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
    ...
    % [D Cello_Voice_I measure 28 / measure 5]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2.                                                                        %! animales.sforzando_exchange_rhythm()
    \repeatTie

    % [D Cello_Voice_I measure 29 / measure 6]                                 %! baca.SegmentMaker._comment_measure_numbers()
    b2                                                                         %! animales.sforzando_exchange_rhythm()
    \repeatTie
...
D_Cello_Voice_I = {                                                            %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Cello_Voice_I measure 30 / measure 7]                         %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c'1 * 1/4                                                          %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \stopTrillSpan                                                     %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.trill_spanner():SpannerIndicatorCommand(2):SPANNER_STOP:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Cello_Rest_Voice_I measure 30 / measure 7]                    %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
...
D_Contrabass_Voice_III_a = {                                                   %! abjad.Path.extern()
    ...
    % [D Contrabass_Voice_III measure 24 / measure 1]                          %! baca.SegmentMaker._comment_measure_numbers()
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
            #16                                                                %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._set_status_tag():REAPPLIED_MARGIN_MARKUP
...
%@% \override Staff.Clef.color = ##f                                           %! baca.SegmentMaker._attach_color_literal(1):REAPPLIED_CLEF_COLOR_CANCELLATION
    ...
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \<                                                                         %! HIDE_TO_JOIN_BROKEN_SPANNERS %! baca.hairpin():baca.PiecewiseCommand._call(1):baca.SegmentMaker._set_status_tag():EXPLICIT_DYNAMIC
    \override Staff.InstrumentName.color = #(x11-color 'OliveDrab)             %! baca.SegmentMaker._attach_color_literal(2):REDRAWN_REAPPLIED_MARGIN_MARKUP_COLOR
    \set Staff.shortInstrumentName =                                           %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._treat_persistent_wrapper(3):baca.SegmentMaker._set_status_tag():REDRAWN_REAPPLIED_MARGIN_MARKUP
    \markup {                                                                  %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._treat_persistent_wrapper(3):baca.SegmentMaker._set_status_tag():REDRAWN_REAPPLIED_MARGIN_MARKUP
        \hcenter-in                                                            %! -PARTS:baca.SegmentMaker._reapply_persistent_indicators(3):baca.SegmentMaker._treat_persistent_wrapper(3):baca.SegmentMaker._set_status_tag():REDRAWN_REAPPLIED_MARGIN_MARKUP
    ...
    % [D Contrabass_Voice_III measure 25 / measure 2]                          %! baca.SegmentMaker._comment_measure_numbers()
    b,1                                                                        %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Contrabass_Voice_III measure 26 / measure 3]                          %! baca.SegmentMaker._comment_measure_numbers()
    b,1                                                                        %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Contrabass_Voice_III measure 27 / measure 4]                          %! baca.SegmentMaker._comment_measure_numbers()
    b,1                                                                        %! baca.make_repeat_tied_notes()
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \ff                                                                        %! baca.hairpin():baca.PiecewiseCommand._call(2):SPANNER_STOP:baca.SegmentMaker._set_status_tag():EXPLICIT_DYNAMIC
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Contrabass_Voice_III measure 28 / measure 5]                          %! baca.SegmentMaker._comment_measure_numbers()
    b,2.                                                                       %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()

    % [D Contrabass_Voice_III measure 29 / measure 6]                          %! baca.SegmentMaker._comment_measure_numbers()
    b,2.                                                                       %! baca.make_repeat_tied_notes()
    \repeatTie                                                                 %! baca.make_repeat_tied_notes()
...
D_Contrabass_Voice_III = {                                                     %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Contrabass_Voice_III measure 30 / measure 7]                  %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:baca.SegmentMaker._style_phantom_measures(5)
            c''1 * 1/4                                                         %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM:PHANTOM_NOTE
        %@% ^ \baca-duration-multiplier-markup #"1" #"4"                       %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER:baca.SegmentMaker._style_phantom_measures(5):PHANTOM
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container():PHANTOM
            ...
            % [D Contrabass_Rest_Voice_III measure 30 / measure 7]             %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(5):PHANTOM
            \once \override Score.TimeSignature.X-extent = ##f                 %! baca.SegmentMaker._style_phantom_measures(6):PHANTOM
            \once \override MultiMeasureRest.transparent = ##t                 %! baca.SegmentMaker._style_phantom_measures(7):PHANTOM
            \stopStaff                                                         %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM
            \once \override Staff.StaffSymbol.transparent = ##t                %! baca.SegmentMaker._style_phantom_measures(8):PHANTOM

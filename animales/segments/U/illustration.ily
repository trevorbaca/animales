...
%@% ^ \baca-dark-cyan-markup [U.1]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [U.2]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \baca-dark-cyan-markup [U.3]                                             %! _label_stage_numbers:STAGE_NUMBER_MARKUP

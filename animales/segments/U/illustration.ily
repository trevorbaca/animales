...
%@% ^ \baca-stage-number-markup "[U.1]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
%@% ^ \baca-clock-time-markup "[4'42'']"                                       %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% - \baca-start-mn-left-only "140"                                           %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
...
%@% \startTextSpan                                                             %! REAPPLIED_METRONOME_MARK:_set_status_tag:_reapply_persistent_indicators(2):_attach_metronome_marks(2)
    ...
    s1 * 1                                                                     %! _make_global_skips(1)
%@% ^ \baca-stage-number-markup "[U.2]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers
...
%@% \bacaStartTextSpanLMN                                                      %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(2)
%@% - \baca-start-mn-both "141" "142"                                          %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER_MARKUP:_label_measure_indices(3)

    % [U Global_Skips measure 142 / measure 3]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% ^ \baca-stage-number-markup "[U.3]"                                        %! STAGE_NUMBER_MARKUP:_label_stage_numbers

...
{                                                                              %! baca.SingleStaffScoreTemplate.__call__()
                                                                               %! baca.SingleStaffScoreTemplate.__call__()
    currentBarNumber = 109                                                     %! baca.SingleStaffScoreTemplate.__call__()
                                                                               %! baca.SingleStaffScoreTemplate.__call__()
}                                                                              %! baca.SingleStaffScoreTemplate.__call__()
                                                                               %! baca.SingleStaffScoreTemplate.__call__()
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__()
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context()
        ...
        {   %*% Page_Layout                                                    %! abjad.ScoreTemplate._make_global_context()
            ...
            \baca-lbsd #0 #'(20 24)                                            %! BREAK:baca.IndicatorCommand._call()
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            % [Page_Layout measure 119]                                        %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM

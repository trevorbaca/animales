...
metadata = abjad.OrderedDict(
    [
        ...
        ('first_measure_number', 109),
        ('last_measure_is_fermata', True),
        ('last_measure_number', 118),
        (
        ...
        ('start_clock_time', "3'33''"),
        ('stop_clock_time', "3'50''"),
        (
            'time_signatures',
            [
                '3/4',

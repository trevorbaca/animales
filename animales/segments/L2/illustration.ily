L_b_GlobalRests = {
    ...
    % [L2 GlobalRests measure 105]                                       %! SM4
    R1 * 3/4
    
    % [L2 GlobalRests measure 106]                                       %! SM4
    R1 * 3/4
    
    % [L2 GlobalRests measure 107]                                       %! SM4
    R1 * 1
    
    % [L2 GlobalRests measure 108]                                       %! SM4
    R1 * 1/2
...
L_b_GlobalSkips = {
    ...
    % [L2 GlobalSkips measure 105]                                       %! SM4
...
%@%     }                                                                %! SM27:REAPPLIED_METRONOME_MARK:SM36 %! SM29:METRONOME_MARK_SPANNER
    ...
    % [L2 GlobalSkips measure 106]                                       %! SM4
    ...
    % [L2 GlobalSkips measure 107]                                       %! SM4
    ...
    % [L2 GlobalSkips measure 108]                                       %! SM4
...
L_b_FirstViolinVoiceV_a = {
    ...
    % [L2 FirstViolinVoiceV measure 105]                     %! SM4
...
%@% \repeatTie                                               %! SHOW_TO_JOIN_BROKEN_SPANNERS %! TCC
    ...
    % [L2 FirstViolinVoiceV measure 106]                     %! SM4
    cs'2.
    :32                                                      %! IC
    \repeatTie                                               %! TCC
    
    % [L2 FirstViolinVoiceV measure 107]                     %! SM4
    cs'1
    :32                                                      %! IC
    \repeatTie                                               %! TCC
    
    % [L2 FirstViolinVoiceV measure 108]                     %! SM4
    cs'2
    :32                                                      %! IC
    \repeatTie                                               %! TCC

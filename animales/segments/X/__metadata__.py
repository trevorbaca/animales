...
metadata = abjad.OrderedDict(
    [
        ...
        (
            ...
            abjad.OrderedDict(
                [
                    ...
                    ('Horn_Rest_Voice_I', False),
                    ('Horn_Rest_Voice_II', False),
                    ('Horn_Rest_Voice_III', False),
                    ('Horn_Rest_Voice_IV', False),
                    ('Horn_Voice_I', True),
                    ('Horn_Voice_II', True),
                    ('Horn_Voice_III', True),
                    ('Horn_Voice_IV', True),
                    ...
                    ('Trombone_Rest_Voice_I', False),
                    ('Trombone_Rest_Voice_II', False),
                    ('Trombone_Rest_Voice_III', False),
                    ('Trombone_Rest_Voice_IV', False),
                    ('Trombone_Voice_I', True),
                    ('Trombone_Voice_II', True),
                    ('Trombone_Voice_III', True),
                    ('Trombone_Voice_IV', True),
                    ('Trumpet_Rest_Voice_I', False),
                    ('Trumpet_Rest_Voice_II', False),
                    ('Trumpet_Rest_Voice_III', False),
                    ('Trumpet_Rest_Voice_IV', False),
                    ('Trumpet_Voice_I', True),
                    ('Trumpet_Voice_II', True),
                    ('Trumpet_Voice_III', True),
                    ('Trumpet_Voice_IV', True),
                    ('Tuba_Rest_Voice_I', False),
                    ('Tuba_Voice_I', True),
                    ('Viola_Voice_I', False),
        ...
        ('start_clock_time', "5'07''"),
        ('stop_clock_time', "5'14''"),
        (
            'time_signatures',
            ['4/4', '2/4', '4/4'],
            ),
